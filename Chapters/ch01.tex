...
\todo[inline]{Check these statemets. Get more info about main milestones}
...
In agreement with the experience in other facilities, it is shown in this dissertation that online optimization using RCDS can succesfully improve the dynamics performance and lead to DA and injection efficiency improvements. Prior to the optimization work, the DA was measured to be  X\todo{get data}, which rendered an average of X\% \todo{get data} injection efficiency. The main difficulty was the typycal fluctuations in the effciency \todo{get data}.
...
\todo[inline]{check: online optimization has been carried out on MAXIV - how many families they have? Any other 4GSR? ERSF?}
