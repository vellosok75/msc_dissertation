\begin{abstract}
    ...
    % In the design phase, SIRIUS DA was numerically optimized in the accelerator model using various techniques, and during commissioning, the optimized lattice was implemented in the machine.
     Prior to optimization, SIRIUS DA was sufficiently large for good injection efficiencies, but showed signs it could be further improved upon fine-tuning of sextupole magnet strengths,
